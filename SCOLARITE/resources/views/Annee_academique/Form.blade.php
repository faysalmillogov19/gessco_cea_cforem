...
<section class="content">
      <form class="container-fluid" action="{{route('annee_academique.store')}}" method="POST">
        @csrf
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Annee academique</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @if(isset($data->id))  <input type="hidden" name="id" value="{{$data->id}}"> @endif
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="libelle" id="exampleInputEmail1" placeholder="Libelle ex(2022-2023)" @if(isset($data->libelle)) value="{{$data->libelle}}" @endif required>
                  </div>
                  <div class="form-group">
