        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a type="button" href="{{route('profession.create')}}" class="btn btn-primary btn-sm float-right">Ajouter <i class="nav-icon fa fa-plus"></i></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                        <a  href="{{route('profession.show',$datum->id)}}" class="btn btn-success btn-sm ">Modifier <i class="nav-icon fa fa-pen"></i></a>
                ...
                <div class="modal fade" id="supprimer{{$datum->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            <a type="button" class="btn btn-primary" href="{{route('profession.edit',$datum->id)}}">Oui</a>
