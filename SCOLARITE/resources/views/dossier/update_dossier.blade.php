<div class="modal fade" id="updatedossier{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form class="modal-body" method="POST" action="{{route('dossier.store')}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="libelle" @if( isset($row->libelle) ) value="{{$row->libelle}}" @endif id="exampleInputPassword1" placeholder="libelle" required>
                  </div>
                  <div class="form-group">
                    <input type="file" class="form-control" name="fichier" id="exampleInputPassword1" placeholder="fichier" accept="application/pdf"  >
