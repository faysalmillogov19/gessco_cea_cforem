        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <a type="button" href="{{route('etudiant.create')}}" class="btn btn-primary btn-sm float-right">Ajouter <i class="nav-icon fa fa-plus"></i></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td>{{$datum->matricule}}</td>
                  <td>{{$datum->date_naissance}}</td>
                  <td>{{$datum->telephone1."/".$datum->telephone2}}</td>
                  <td>{{$datum->email}}</td>
                  <td>  
                        <a  href="{{route('inscription.show',$datum->id)}}" class="btn btn-info btn-sm ">Inscription <i class="nav-icon fas fa-drafting-compass"></i></a>
                        <a  href="{{route('etudiant.show',$datum->id)}}" class="btn btn-success btn-sm "> <i class="nav-icon fa fa-pen"></i></a>
                ...
                <div class="modal fade" id="supprimer{{$datum->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            <a type="button" class="btn btn-primary" href="{{route('etudiant.edit',$datum->id)}}">Oui</a>
