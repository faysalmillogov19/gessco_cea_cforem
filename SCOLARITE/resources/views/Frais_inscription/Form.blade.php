                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      @if(isset($data->annee_academique))<option value="{{$data->annee_academique}}">{{ $data->libelle_annee_academique }}</option>@endif
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="number" class="form-control" name="montant" id="exampleInputPassword1" placeholder="montant" @if(isset($data->montant)) value="{{$data->montant}}" @endif >
                    </div>
