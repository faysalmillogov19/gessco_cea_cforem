...
<section class="content">
      <form class="container-fluid" action="{{route('element_scolarite.store')}}" method="POST">
        @csrf
              ...
              @if(isset($data->id))  <input type="hidden" name="id" value="{{$data->id}}"> @endif
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select name="type_element_scolarite" class="custom-select" required>
                      @if(isset($data->libelle_type_element))<option value="{{$data->type_element_scolarite}}">{{ $data->libelle_type_element }}</option>@endif
                      <option disabled></option> 
                      @foreach($var['type_element_scolarites'] as $row)
