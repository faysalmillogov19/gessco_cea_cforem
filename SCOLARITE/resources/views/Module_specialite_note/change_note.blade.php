<div class="modal fade container" id="change{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" >        <div class="modal-content">
            ...
            <form class="modal-body container" method="POST" action="{{route('module_specialite_note.store')}}">
                @csrf
                  @if(isset($row->id)) <input type="hidden" name="inscription" value="{{$row->id}}"> @endif
